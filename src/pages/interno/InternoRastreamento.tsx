...
export default function InternoRastreamento() {
  ...
  return <div className="mx-auto w-full max-w-[1500px] space-y-6">
    ...
    <div className="grid grid-cols-2 gap-3 xl:grid-cols-4">{[
      ['Links enviados', stats.sent, Send, 'text-[#E8C766]'], ['Pessoas que clicaram', stats.clicked, MousePointerClick, 'text-sky-400'],
      ['Conversões', stats.conversions, CheckCircle2, 'text-emerald-400'], ['Receita rastreada', money.format(stats.revenue), BarChart3, 'text-[#E8C766]'],
